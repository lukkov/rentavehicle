...
class UserType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add('roles', ChoiceType::class, [
            ...
            'get_value' => fn (User $user) => $user->getRoles(),
            'update_value' => fn (array $roles, User $user) => $user->setRoles($roles),
            'multiple' => true,
            'expanded' => true,
        ]);
    }
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            ...
            'factory' => fn (string $firstName, string $lastName, string $email, string $password, array $roles) => new User($firstName, $lastName, $email, $this->encoder->encodePassword($password, null), $roles),
